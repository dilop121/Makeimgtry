...
from AdisaX.utils.admins import can_change_info
from AdisaX.utils.errors import capture_err
from AdisaX.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|dil|thank you|gud|thankyou|love|pro)$"
