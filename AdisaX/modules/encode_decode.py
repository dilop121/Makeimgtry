import requests
from .. import pbot as Adisa,BOT_NAME,BOT_USERNAME
import time
from pyrogram.enums import ChatAction, ParseMode
from pyrogram import filters
@Adisa.on_message(filters.command(["password"]))
...
@Adisa.on_message(filters.command(["morseencode"]))
async def morse_en(bot, message):
    ...
    try:
        ...
        await message.reply_text(f"**ᴇʀʀᴏʀ: {e} ")
@Adisa.on_message(filters.command("morsedecode"))
async def morse_de(bot, message):
    ...
    try:
        ...
        await message.reply_text(f"**ᴇʀʀᴏʀ: {e} ")
@Adisa.on_message(filters.command(["encode"]))
async def base_en(bot, message):
    ...
    try:
        ...
        await message.reply_text(f"**ᴇʀʀᴏʀ: {e} ")
@Adisa.on_message(filters.command(["decode"]))
