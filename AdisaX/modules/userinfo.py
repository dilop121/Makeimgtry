...
from AdisaX.modules.alive import dilop
import AdisaX.modules.sql.userinfo_sql as sql
from AdisaX import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from AdisaX.__main__ import STATS, TOKEN, USER_INFO
from AdisaX.modules.disable import DisableAbleCommandHandler
from AdisaX.modules.helper_funcs.chat_status import sudo_plus
from AdisaX.modules.helper_funcs.extraction import extract_user
from AdisaX.modules.sql.global_bans_sql import is_user_gbanned
from AdisaX.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/LOVE_FEELINGS_WILL16">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/LOVE_FEELINGS_WILL1"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/LOVE_FEELINGS_WILL1"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/dil_sagar_121"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/LOVE_FEELINGS_WILL1"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
