...
import AdisaX.modules.no_sql.users_db as user_db 
from AdisaX import pbot as Adisa
from AdisaX import DEV_USERS, LOGGER as  logger, OWNER_ID, dispatcher
from AdisaX.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from AdisaX.modules.no_sql.users_db import get_all_users
...
@dev_plus
@Adisa.on_message(filters.command("bchat") & filters.user(OWNER_ID) & filters.reply)
...
@dev_plus
# broadcast
@Adisa.on_message(filters.command("buser") & filters.user(OWNER_ID) & filters.reply)
async def broadcast_handler(bot: Client, m: Message):
